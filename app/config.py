...
# Reader-facing decile labels. Every chart that used to say "D1"/"Decile 1"
# now anchors the slice by the typical annual household income inside it —
# data-science jargon replaced with a dollar figure the reader already
# understands. Values are back-calculated from Yale's Feb 2026
# distributional data (burden_USD ÷ burden_share), rounded to nearest $1k;
# see data/cleaned/yale_distributional_raw.csv. The ordering is poorest
# (index 0) → richest (index 9), parallel to DECILE_COLORS.
DECILE_INCOME_LABELS = [
    "$38k",   # poorest 10%
    "$60k",
    "$74k",
    "$86k",
